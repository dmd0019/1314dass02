...
public class LANTests extends TestCase {
	...
	public void testBasicNode() {
		...
		node = Node.createNode(Node.NODE, "n");
		assertEquals("type_", node.getClass(), Node.class);
	...
	/*
	 * static public class PreconditionViolationTestCase extends
	 * ExceptionTestCase { public PreconditionViolationTestCase(String name,
	 * Class exception) { super(name, exception); }
	 */
	...
	/*
	 * public void testPreconditionViolation() { PreconditionViolationTestCase
	 * test= new PreconditionViolationTestCase("test", AssertionError.class);
	 * TestResult result= test.; assertEquals(1, result.runCount());
