...
@return Anwer #true when the broadcast operation was succesful and #false otherwise
	...
	private void send(Writer report, Node currentNode, Packet packet){
			...
			logRequest(report, currentNode);
			if( ! atDestination(currentNode.nextNode_, packet)){
				send(report, currentNode.nextNode_, packet);
			}
	}
...
@return Anwer #true when the print operation was succesful and #false otherwise
	...
	/**
	 * @deprecated Use {@link lanSimulation.internals.Node#printDocument(lanSimulation.Network,Packet,Writer)} instead
	 */
...
Write a HTML representation of #receiver on the given #buf.
 <p><strong>Precondition:</strong> isInitialized();</p>
	...
	private void printNodeName(StringBuffer buf, Node currentNode) {
